...
from hypermind.moe.client.expert import RemoteExpert, batch_create_remote_experts, create_remote_experts
from hypermind.moe.expert_uid import (
    FLAT_EXPERT,
    PREFIX_PATTERN,
    UID_DELIMITER,
    Coordinate,
...
from hypermind.utils import DHTExpiration, MPFuture, ValueWithExpiration, get_dht_time, get_logger
...
class MoEBeamSearcher:
    ...
    A hypermind.moe.Server can ``declare_experts(dht, expert_uids: List[str])`` to make its experts visible to everyone.
