...
from hypermind.averaging.partition import AllreduceException, BannedException, TensorPartContainer, TensorPartReducer
from hypermind.compression import deserialize_torch_tensor, serialize_torch_tensor
from hypermind.p2p import P2P, P2PContext, PeerID, ServicerBase, StubBase
...
class AllReduceRunner(ServicerBase):
    ...
    This class inherits hypermind.p2p.ServicerBase, so it can be used as an RPCServicer for testing purposes without
    ...
    :param p2p: a hypermind.p2p.P2P instance used for communication with other peers
    :param servicer_type: a hypermind.p2p.ServicerBase subclass whose RPC signatures are used
