...
# pytest tests/ed25519/test_dht_node.py -rP
...
async def test_dht_node(
    ...
    print("test_dht_node node_id", me.node_id)
    print("test_dht_node peer_id", me.peer_id)

    logger.info("test_dht_node node_id")
    logger.info("test_dht_node peer_id")
